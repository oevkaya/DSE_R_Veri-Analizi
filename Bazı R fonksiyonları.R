...
help("mean") # Help on function foo (the quotation marks are optional). 
?mean

help.search("mean") #Search the help system for instances of the

example("mean") #Examples of function foo (the quotation marks
               #                          are optional).
...
mode() # get the most frequent value in a data set
